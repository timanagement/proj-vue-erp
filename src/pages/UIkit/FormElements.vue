                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="radio">
                        <label class="radio-custom">
                          ...
                          <i class="fa fa-circle-o checked"></i> Item one checked </label>
                      </div>
                      <div class="radio">
                        <label class="radio-custom">
                      ...
                      <div class="radio">
                        <label class="radio-custom">
                          ...
                          <i class="fa fa-circle-o disabled"></i> Item three disabled </label>
                      </div>
                      <div class="radio">
                        <label class="radio-custom">
                          <input type="radio" checked="checked" disabled="disabled">
                          <i class="fa fa-circle-o checked disabled"></i> Item four checked disabled </label>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <!-- checkbox -->
                      <div class="checkbox">
                        <label class="checkbox-custom">
                          ...
                          <i class="fa fa-fw fa-square-o checked"></i> Item one checked </label>
                      </div>
                      <div class="checkbox">
                        <label class="checkbox-custom">
                      ...
                      <div class="checkbox">
                        <label class="checkbox-custom">
                          ...
                          <i class="fa fa-fw fa-square-o disabled"></i> Item three disabled </label>
                      </div>
                      <div class="checkbox">
                        <label class="checkbox-custom">
                          <input type="checkbox" name="checkboxD" checked="checked" disabled="disabled">
                          <i class="fa fa-fw fa-square-o checked disabled"></i> Item four checked disabled </label>
                      </div>
                    </div>
                  </div>
                </div>
